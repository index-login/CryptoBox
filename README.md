...
- **批量处理** - 支持多行文本逐行处理
- **暗色主题** - 专为安全工具设计的深色 UI
- **摸鱼小站** - 专属彩蛋页面（[moyu.html](moyu.html)）：合成爱心 / 熊熊飞呀双游戏 + 摸鱼日历（下班倒计时/节日倒数/每日语录）+ 今天吃什么 + 指尖仙女棒烟花 + 爱心氛围特效，手机端单手可玩
...
| 摸鱼小站 🐟 | 独立页面 [moyu.html](moyu.html)：双游戏（💖 合成爱心物理合成 / 🐻 熊熊飞呀可爱 Flappy，均带最高分与彩蛋）+ 摸鱼日历（下班倒计时/节日倒数/本周进度/每日语录）+ 今天吃什么随机抽 + 指尖仙女棒烟花与爱心特效，昵称/菜单/节日等在页面内 CONFIG 区自定义 |
