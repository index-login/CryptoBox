...
- **批量处理** - 支持多行文本逐行处理
- **暗色主题** - 专为安全工具设计的深色 UI
- **摸鱼小站** - 专属彩蛋页面（[moyu.html](moyu.html)）：🐻 熊熊飞呀（反应）+ ⛳ 一杆进洞（弹射技巧）双游戏 + 摸鱼日历 + 今天吃什么 + 指尖仙女棒烟花 + 爱心氛围特效，手机端单手可玩；游戏规划见 [docs/摸鱼小站-游戏需求.md](docs/摸鱼小站-游戏需求.md)
...
| 摸鱼小站 🐟 | 独立页面 [moyu.html](moyu.html)：🐻 熊熊飞呀（可爱 Flappy，最高分彩蛋）+ ⛳ 一杆进洞（拉弓弹射高尔夫，💗⚡🧲🌟 五种技能球）+ 摸鱼日历（下班倒计时/节日倒数/本周进度/每日语录）+ 今天吃什么（页面内可编辑菜单）+ 指尖仙女棒烟花与爱心特效；游戏规划见 [游戏需求文档](docs/摸鱼小站-游戏需求.md)，昵称/菜单等在页面内 CONFIG 区自定义 |
