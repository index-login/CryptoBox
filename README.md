...
- **批量处理** - 支持多行文本逐行处理
- **暗色主题** - 专为安全工具设计的深色 UI
- **摸鱼小站** - 专属彩蛋页面（[moyu.html](moyu.html)）：合成爱心小游戏 + 摸鱼日历（下班倒计时/节日倒数/每日语录），手机端单手可玩
...
| 摸鱼小站 🐟 | 独立页面 [moyu.html](moyu.html)：合成爱心物理小游戏（最高分记录）+ 摸鱼日历（下班倒计时/节日倒数/本周进度/每日语录），昵称等在页面内 CONFIG 区自定义 |
